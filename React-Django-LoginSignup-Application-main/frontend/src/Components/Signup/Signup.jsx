...
function Signup() {
    ...
    return (
        <div>
            ...
            <section style={{backgroundImage: "url('../../../Images/homepage_bg.png')"}} className="bg-cover w-full  mx-auto text-center flex flex-col justify-center items-center">
                {/* Background Image */}
                <div className="bg-black p-10 bg-opacity-25">
                <form onSubmit={handleSubmit} className=" w-full max-w-lg">
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-green-500 text-lg font-bold mb-2" htmlFor="grid-first-name">
                        First Name
                    </label>
                    ...
                    <label className="block uppercase tracking-wide text-green-500 text-lg font-bold mb-2" htmlFor="grid-last-name">
                        Last Name
                    </label>
                    <input name="lastname" value={lastname}
                        onChange={(e) => {
                          setLastname(e.target.value);
                        }} className="appearance-none block w-full bg-gray-200 text-green-500 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Doe" />
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-green-500 text-lg font-bold mb-2" htmlFor="grid-username">
                        Username
                    </label>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-green-500 text-lg font-bold mb-2" htmlFor="grid-email">
                        Email
                    </label>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <label className="block uppercase tracking-wide text-green-500 text-lg font-bold mb-2" htmlFor="grid-password">
                        Password
                    </label>
